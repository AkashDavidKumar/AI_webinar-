...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function validateStep(stepIndex) {
        ...
        if (stepIndex === 0) {
            ...
            // STEP 2 VALIDATIONS (Payment) - Now fully optional!
            clearError(screenshotInput);
            isValid = true;
        } 
            ...
            if (!confirmDetails.checked) {
                showError(confirmDetails, "You must confirm that your registration details are correct.");
                isValid = false;
            } else {
                clearError(confirmDetails);
            }
    ...
    form.addEventListener('submit', (e) => {
        ...
        const payload = {
            ...
            updates: formData.get('receive-updates') ? "Yes" : "No",
